...
careertweet = "Thinking about #careerdestinations? how about a " + \
                random.choice(careers) + " http://blablacareerjob.com"
...
###################################
commands = [
    "convert -resize 1920x foo.png bar.jpg",
    "qrencode -size 30 http://someurl.org -o qrcode_someurl.png"
]
commandoftheday = "#commandoftheday" + random.choice(commands) + "#digitalmediacov"
###################################

allothertweets = [readingtweet, watchingtweet, careertweet, optionstweet, advantagetweet, commandoftheday];
